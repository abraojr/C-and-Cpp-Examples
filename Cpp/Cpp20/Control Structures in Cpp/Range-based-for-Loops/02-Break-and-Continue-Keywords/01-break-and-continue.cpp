...
int main()
{
    float student_scores[10]{2.3, 4.1, 7.9, 8.2, 6.4, 7.7};
...
/* OUTPUT
    ...
    student_score at index 6 = 0
    student_score at index 7 = 0
    student_score at index 8 = 0
    student_score at index 9 = 0
*/