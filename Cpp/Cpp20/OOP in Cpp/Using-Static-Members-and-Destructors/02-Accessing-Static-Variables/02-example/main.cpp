...
int main()
{
    ...
    cout << "Total number of student objects in Math (using object): "
         << george.get_major_count("Math") << endl;

    cout << "Total number of student objects in Chemistry (using object): "
...
/* OUTPUT
    Total number of student objects in Math (using object): 2
    Total number of student objects in Chemistry (using object): 3
*/