...
int main()
{
    ...
    cout << "--------------------------------" << endl;
    cout << "First circle's radius: " << first_circle.radius << endl;
    cout << "Second circle's radius: " << second_circle.radius << endl;
...
/* OUTPUT
    ...
    --------------------------------
    First circle's radius: 10
    Second circle's radius: 12
    --------------------------------
