...
GraduateStudent::GraduateStudent(string name, bool scholarship) : Student(name), scholarship(scholarship)
{
    cout << "GraduateStudent(name, scholarship) ctor" << endl;
}

GraduateStudent::GraduateStudent(string name, float gpa, bool scholarship) : Student(name, gpa), scholarship(scholarship)
{
