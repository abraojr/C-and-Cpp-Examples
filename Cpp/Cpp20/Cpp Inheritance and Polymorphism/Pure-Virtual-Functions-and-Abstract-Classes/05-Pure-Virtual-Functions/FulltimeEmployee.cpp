...
FulltimeEmployee::FulltimeEmployee(string name, float base_salary, float bonus_percent) : Employee("fulltime", name), base_salary(base_salary), bonus_percent(bonus_percent) {}
