...
{
    std::cout << "Invoking bool operator<(const BankAccount &first, const BankAccount &second)" << std::endl;
...
{
    std::cout << "Invoking bool operator<(const BankAccount &first, double second)" << std::endl;
...
{
    std::cout << "Invoking bool operator<(double first, const BankAccount &second)" << std::endl;
