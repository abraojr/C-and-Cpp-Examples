...
int main()
{
    ...
    {
        cout << "Troy's balance is greater than or equal to Carrie's balance" << endl;
    }
...
/* OUTPUT
    ...
    ----------------Troy----------------
    Balance: 4325.45 Credit card amount due: 100

    Carrie's balance is less than or equal to Troy's balance
    ----------------------------
    Troy's balance is greater than or equal to Carrie's balance
    ----------------------------
    Troy's balance is not equal to Carrie's balance
    ----------------------------
*/