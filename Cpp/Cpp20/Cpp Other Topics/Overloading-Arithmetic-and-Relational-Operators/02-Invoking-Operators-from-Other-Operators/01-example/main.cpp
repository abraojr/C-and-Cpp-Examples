...
int main()
{
    ...
    {
        cout << "$5333.34 is greater than Troy's balance" << endl;
    }
...
/* OUTPUT
    ...
    Troy's balance is greater than Carrie's balance
    ----------------------------
    Troy's balance is greater than $1000
    ----------------------------
    $5333.34 is greater than Troy's balance
*/