...
public:
    InvalidInputException(std::string message, std::string invalid_var_name) : BrowserException(message), invalid_var_name(invalid_var_name) {}

    InvalidInputException(const InvalidInputException &other) : BrowserException(other.BrowserException::what()),
