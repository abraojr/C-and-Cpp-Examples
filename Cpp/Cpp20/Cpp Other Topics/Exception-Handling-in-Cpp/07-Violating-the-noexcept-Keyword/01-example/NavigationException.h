...
public:
    NavigationException(std::string message, std::string last_url) : BrowserException(message), last_url(last_url) {}

    NavigationException(const NavigationException &other) : BrowserException(other.BrowserException::what()),
