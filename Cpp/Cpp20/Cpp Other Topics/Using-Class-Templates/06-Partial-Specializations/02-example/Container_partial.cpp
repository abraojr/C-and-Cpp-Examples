...
template <typename U>
Container<string, U>::Container(string first_element, U second_element) : first_element(first_element), second_element(second_element)
{
...
template <typename U>
bool Container<string, U>::operator>(const Container<string, U> &other) const
{
