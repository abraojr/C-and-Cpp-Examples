...
int main()
{
    Container<int, string> int_string_container{3, "Harry Potter and the Prisioner of Azkaban"};
...
/* OUTPUT
    3: Harry Potter and the Prisioner of Azkaban
    Partial specialization constructor called: Harry Potter and the Chamber of Secrets, 8.99
