...
int main()
{
    ...
    // Initialize one string with the contents of another string
...
/* OUTPUT
    proverb_1: A bad workman always blames his tools
    proverb_2: A bad workman always blames his tools
    proverb_part: bad workman
    repeated_s: ssssssssss
*/