...
int main()
{
    ...
    vector<string> string_vector{"Rosalind", "John", "Tim", "Igor", "Geraldine"};

    cout << "String------------------" << endl;
    cout << "Longest string is: " << find_max_or_min(string_vector, [](const string &a, const string &b) { return a.length() > b.length(); }) << endl;
    cout << "Shortest string is: " << find_max_or_min(string_vector, [](const string &a, const string &b) { return a.length() < b.length(); }) << endl;
