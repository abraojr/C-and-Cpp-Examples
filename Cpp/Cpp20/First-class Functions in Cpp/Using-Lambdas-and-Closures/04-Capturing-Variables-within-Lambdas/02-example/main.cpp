...
int main()
{
    ...
    vector<float> result_vector = apply_transform(float_vector, [multiplier, divisor](const float &elem) { return elem * multiplier / divisor; });
...
/* OUTPUT
    --------------Original Values--------------
    12.3 57.5 90.6 119.1 456.22 33.56 91.11 115.98 220.33

    --------------(x * 10) / 3 Values--------------
    410 1916.67 3020 3970 15207.3 1118.67 3037 3866 7344.33
*/