...
int main()
{
    ...
    vector<int> result_vector = apply_transform(int_vector, [multiplier](const int &elem) { return elem * multiplier; });
...
/* OUTPUT
    ...
    --------------Multiplied by 10 Values--------------
    120 570 900 1190 4560 330 910 1150 2200
*/