...
int main()
{
    ...
    {
        cout << "The original strong pointer is no longer available" << endl;
    }
...
/* OUTPUT
    ...
    nina_ptr: Nina
    temp_sp: Nina
    Constructing person Some Other Nina
    Destructing person Nina
    The original strong pointer is no longer available
    Destructing person Some Other Nina
*/