...
int main()
{
    ...
    {
        *double_ptr = 12098.23;
        printf("Value referenced by char_ptr: %lf\n", *double_ptr);
    }
...
/* OUTPUT
    Value referenced by int_ptr: 1000
    Value referenced by float_ptr: 234.119995
    Value referenced by char_ptr: m
    Value referenced by char_ptr: 12098.230000
*/